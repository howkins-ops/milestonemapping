...
export const ARENA_GAMES = [
  {
    key: "the_vow",
    title: "The Vow",
    image: "/assets/zone/arena/the-vow.webp",
    short: "Set a timed promise and prove it before the fuse ends.",
    summary: "Choose a task, pick a deadline, add a witness if you want, then post proof to defuse it.",
    benefit: "Good for turning a vague intention into one clear next move.",
  ...
  },
  {
    key: "boss_forge",
    title: "Boss Forge",
    image: "/assets/zone/arena/boss-forge.webp",
    short: "Fight a weekly squad boss with real check-ins.",
    summary: "Post proof for the day. Every squadmate's proof damages the boss until the team brings it down.",
    benefit: "Good for making consistency feel visible and shared.",
  ...
  },
  {
    key: "chain_of_fire",
    title: "Chain of Fire",
    image: "/assets/zone/arena/chain-of-fire.webp",
    short: "Keep one shared streak alive with your squad.",
    summary: "Everyone checks in. If one person misses, the link waits; Ember Freezes buy a grace day.",
    benefit: "Good for daily follow-through without making one bad day fatal.",
  ...
  },
  {
    key: "full_court",
    title: "Hoops",
    image: "/assets/zone/arena/hoops.webp",
    short: "Track a sales day like four quarters of basketball.",
    summary: "Tap each action as it happens: knock, value build, price drop, close. The scoreboard keeps you moving.",
    benefit: "Good for making boring sales reps feel like a live game.",
  ...
  },
  {
    key: "the_duel",
    title: "The Duel",
    image: "/assets/zone/arena/the-duel.webp",
    short: "Go one-on-one for seven days of proof.",
    summary: "Challenge your partner. Both of you log real activity for a week; the higher proof score wins.",
    benefit: "Good for friendly pressure when you need another person in the game.",
  ...
  },
  {
    key: "ascension",
    title: "Ascension",
    image: "/assets/zone/arena/ascension.webp",
    short: "Climb weekly squad divisions with real proof.",
    summary: "Your squad earns points from logged activity. Top squads rise, quiet squads drop, and next week resets the climb.",
    benefit: "Good for making long-term team momentum easy to see.",
  ...
  },
  {
    key: "dawn_raid",
    title: "Dawn Raid",
    image: "/assets/zone/arena/dawn-raid.webp",
    short: "Race to finish your hardest task before 9AM.",
    summary: "Do the task you are avoiding, post proof early, and land on the sunrise board.",
    benefit: "Good for starting the day before distraction takes over.",
  ...
  },
  {
    key: "eat_the_frog",
    title: "Eat the Frog",
    image: "/assets/zone/arena/eat-the-frog.webp",
    short: "Name the task you are avoiding, then finish it.",
    summary: "Write down the one ugly task. Do it in real life, then hold the button to mark it eaten.",
    benefit: "Good for ADHD overwhelm because it picks one target, not ten.",
  ...
  },
  {
    key: "the_pit",
    title: "The Pit",
    image: "/assets/zone/arena/the-pit.webp",
    short: "Put a non-money stake on a promise.",
    summary: "Choose a vow or challenge, add a fire/Cups/ego stake, and let your partner verify the result.",
    benefit: "Good for commitments that need a little consequence.",
  ...
  },
  {
    key: "grind_room",
    title: "Grind Room",
    image: "/assets/zone/arena/grind-room.webp",
    short: "Tap into a live focus room with your squad.",
    summary: "Clock in when you are working. Squadmates can see you are present, and you can leave anytime.",
    benefit: "Good for body-doubling: staying focused because someone else is working too.",
