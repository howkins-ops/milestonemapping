...
const GAMES = [
  ...
  },
  {
    ...
    relic: "The Threshold",
    sub: "Ride the block at dawn and put a door hanger on every door you can reach — hook a handle and he answers half-expecting you, put one through his window and he opens swinging. Then walk it back and knock. Five houses, escalating warfare: knock through the screaming, breach a gated community, saw your way through steel, and finish every one of them in a Punch-Out bout on the porch. 21+, sound on.",
    tag: "Paperboy × Punch-Out · 5 houses · 21+",
    accent: "#FF3B5C",
    live: true,
  },
  {
