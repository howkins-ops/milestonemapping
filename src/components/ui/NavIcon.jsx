...
const ICONS = {
  ...
  anger: (
    <>
      <path d="M12 3.5c2.4 3 3.6 5.2 3.6 7a3.6 3.6 0 0 1-7.2 0c0-.9.3-1.8.9-2.7-.2 1.8-1.6 2-1.6 3.4C7.7 16.7 9.5 20.5 12 20.5s4.3-2.9 4.3-6c0-3.8-2.1-7.4-4.3-11Z" />
      <path d="M11.4 14.2c.4.9 1.4 1.1 2 .4" className="nav-icon__spark" />
    </>
  ),
  zone: (
    <>
      <path d="M12 3c1.8 2.6 4.6 4.1 4.6 7.4 0 1.6-.7 3-1.8 3.9.2-2.3-1-3.6-2.8-4.8-1.8 1.2-3 2.5-2.8 4.8a5 5 0 0 1-1.8-3.9C7.4 7.1 10.2 5.6 12 3Z" />
      <path d="M6.5 15.5c1.4 2.6 3.2 4 5.5 4s4.1-1.4 5.5-4" className="nav-icon__spark" />
