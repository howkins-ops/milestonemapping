...
export const CHAPTER_COMPONENTS = {
  ...
  ChapterCrystalShop: lazy(() => import("./chapters/ChapterCrystalShop.jsx")),
  ChapterDisplayCase: lazy(() => import("./chapters/ChapterDisplayCase.jsx")),
  ChapterThirst: lazy(() => import("./chapters/ChapterThirst.jsx")),
  ChapterMerchantsDream: lazy(() => import("./chapters/ChapterMerchantsDream.jsx")),
