...
export const QUEST_CHAPTERS = [
  ...
  // ── ARC 2 · THE FALL & THE CRYSTAL SHOP (Ch 6–10) ────────────────────────
  {
    ...
    subtitle: "Meet the Broke King — and learn the Four Turns.",
    world: "The ruined treasury beneath the city.",
    exercise: "Money Mirror + The Four Turns", shadow: "broke_king", essence: "Majesty", consent: "Testimony",
    reward: "Essence: Majesty + the Four Turns", type: "Story + exercise",
  ...
  },
  {
    ...
    exercise: "Throne of Responsibility", shadow: "raging_victim", essence: "Power", consent: "Transmuted",
    reward: "Essence: Power", type: "Story + exercise",
