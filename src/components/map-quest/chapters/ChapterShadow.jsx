...
/* ===== root ============================================================== */
export default function ChapterShadow({ onComplete }){
  ...
  useEffect(()=>{
    if(phase==="handoff"&&!completeFired&&onComplete){
      ...
      onComplete({ helped:state.helped, doing:state.doing, chasing:state.chasing, reflections:state.reflections, seedPlanted:true, shadowMask:"broke_king" });
    }
