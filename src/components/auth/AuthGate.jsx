...
const S = {
  ...
  form: { display: "flex", flexDirection: "column", gap: "0.68rem", width: "100%", maxWidth: "340px" },
  label: { display: "flex", flexDirection: "column", gap: "0.24rem", fontSize: "0.55rem", letterSpacing: "0.13em", color: "rgba(234,251,255,0.45)", fontWeight: 600 },
  input: {
